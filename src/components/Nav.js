...
const Nav = () => {
    return (
        <div className='fixed flex justify-around items-center w-full pt-3 bg-gradient-to-b from-stone-50 to-stone-100 dark:from-stone-900 dark:to-stone-800 shadow shadow-stone-900/10 dark:shadow-stone-50/10 h-20 z-50 font-medium'>
            <div className=''>
