...
const Nav = () => {
    return (
        <div className='fixed flex justify-around items-center w-full pt-3 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 shadow shadow-gray-900/10 dark:shadow-gray-50/10 h-20 z-50 font-medium'>
            <div className=''>
