...
const Nav = () => {
    return (
        <div className='fixed flex justify-around items-center w-full pt-3 bg-gradient-to-b from-zinc-50 to-zinc-100 dark:from-zinc-900 dark:to-zinc-800 shadow shadow-zinc-900/10 dark:shadow-zinc-50/10 h-20 z-50 font-medium'>
            <div className=''>
